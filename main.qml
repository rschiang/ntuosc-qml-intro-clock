...
Rectangle {
    ...
    Rectangle {
        ...
        OpacityMask {
            ...
            visible: (x != 0 || y != 0)
            x: clock.radius + clock.radius * (1 - radius / clock.radius) * Math.cos((6.0 * clock.second - 90.0) / 360.0 * 2 * Math.PI) - radius
            y: clock.radius + clock.radius * (1 - radius / clock.radius) * Math.sin((6.0 * clock.second - 90.0) / 360.0 * 2 * Math.PI) - radius
            z: 1
